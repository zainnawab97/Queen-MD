...
global.ownername = process.env.OWNER_NAME === undefined ? "𝐙𝐀𝐈𝐍" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '923074060856' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
global.ownernumber = [`${fake}`]
global.premium = [`${fake}`]
global.anticall = process.env.ANTICALL === undefined ? 'false' : process.env.ANTICALL
global.packname = process.env.PACK_NAME === undefined ? 'Zain🥰NawabZaaDaa' : process.env.PACK_NAME
